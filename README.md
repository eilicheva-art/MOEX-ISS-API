# MOEX-ISS-API
Реализована выгрузка истории сделок за нужный торговый день по рынку акций, сохранение данных в формате parquet в HDFS и последующая загрузка данных в greenplum
